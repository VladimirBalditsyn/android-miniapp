package com.balditsyn.stackoveflow.di

import android.app.Application
import androidx.room.Room
import com.balditsyn.stackoveflow.data.local.AppDatabase
import com.balditsyn.stackoveflow.data.local.dao.QuestionDao
import com.balditsyn.stackoveflow.data.remote.StackOverflowApi
import com.balditsyn.stackoveflow.data.repository.QuestionRepository
import com.balditsyn.stackoveflow.ui.QuestionListViewModel
...
import com.balditsyn.stackoveflow.ui.AnswerListViewModel
...
val databaseModule = module {
    ...
    fun provideDatabase(application: Application): AppDatabase {
        return Room.databaseBuilder(application, AppDatabase::class.java, "stackouverflow")
            .build()
    }
